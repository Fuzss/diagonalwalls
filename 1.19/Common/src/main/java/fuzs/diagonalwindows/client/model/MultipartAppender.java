...
import fuzs.diagonalwindows.mixin.client.accessor.*;
...
public class MultipartAppender {
    ...
    public static void onPrepareModelBaking(ModelBakery modelBakery) {
        ...
        DiagonalWindows.LOGGER.info("Constructing diagonal block models took {} milliseconds", stopwatch.stop().elapsed().toMillis());
    }
